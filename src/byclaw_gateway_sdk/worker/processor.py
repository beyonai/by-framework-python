...
from byclaw_gateway_sdk.common.constants import MESSAGE_ID_PREFIX
from byclaw_gateway_sdk.core.protocol.agent_state import AgentState
from byclaw_gateway_sdk.core.protocol.commands import (GatewayCommand, ResumeCommand)
from byclaw_gateway_sdk.core.protocol.events import StateChangeEvent
...
class GatewayProcessor:
    ...
    def __init__(
        ...
        from byclaw_gateway_sdk.common.redis_client import get_redis
