...
from byclaw_gateway_sdk.common.redis_client import (close_redis, get_redis, init_redis)
...
class TestRedisClient(unittest.IsolatedAsyncioTestCase):
    ...
    async def asyncSetUp(self):
        ...
        import byclaw_gateway_sdk.common.redis_client as rc
    ...
    async def test_init_redis_singleton(self):
        """验证 init_redis 返回单例"""
        with patch("byclaw_gateway_sdk.common.redis_client.Redis") as mock_redis_cls:
